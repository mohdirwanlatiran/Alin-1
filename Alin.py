...
cl = LINETCR.LINE()
cl.login(token="AUTH TOKEN KAMU")
cl.loginResult()
...
helpMessage ="""✟Ƥɾøтøтуρє✟一�:緑 BOTS
...
#----------------------ADMIN COMMAND------------------------------#
            ...
            elif "Getdp @" in msg.text:            
                print "[Command]dp executing"
                _name = msg.text.replace("Getdp @","")
